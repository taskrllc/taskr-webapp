<div class="text-center min-h-screen">
    <h1 class="text-2xl font-bold">We clean house. You give moeny.</h1>
    <div class="min-h-32"></div>
    <p class="scroll-py-6 max-w-96">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras in turpis

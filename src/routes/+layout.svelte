...
>
    <aside>
        <img width="50" height="50" src={logo} class="fill-current" alt="" />
        <p>
            taskr, LLC.
            <br />
    ...
    <nav>
        ...
        <div class="grid grid-flow-col gap-4">
            <a title="" href="https://x.com/taskr">
                <svg
            ...
            <a title="" href="https://youtube.com/@taskr-llc">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
            ...
            <a title="" href="https://facebook.com/@taskr-llc">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
